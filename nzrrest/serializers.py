    ...
    def _get_model_fields(cls) -> Dict[str, Field]:
        ...
        if hasattr(model, '__table__'):
            for column in model.__table__.columns:
                ...
                if (hasattr(cls.Meta, 'exclude') and 
                    cls.Meta.exclude and 
                    field_name in cls.Meta.exclude):
                    continue
                
                # Skip if not in explicit fields list
                if (hasattr(cls.Meta, 'fields') and 
                    cls.Meta.fields != '__all__' and 
                    field_name not in cls.Meta.fields):
                    continue
