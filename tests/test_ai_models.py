...
from nzrrest.ai.protocol import MCPRequest, MCPResponse, ContextData
...
class TestAIRegistry:
    ...
    async def test_predict_through_registry(self, registry):
        ...
        # Add and load model
        await registry.add_model("test_model", "mock", {
            "name": "test_model",
            "mock_responses": {"hello": "Hi from registry!"}
        })
