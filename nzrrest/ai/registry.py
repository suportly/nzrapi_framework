...
from .protocol import ModelHealth, BatchMCPRequest, BatchMCPResponse, MCPRequest, MCPResponse, MCPError
...
class AIRegistry:
    ...
    async def predict(self, model_name: str, payload: Dict[str, Any], 
    ...
    async def process_mcp_request(self, request: MCPRequest, 
